...
router.post(
  "/customer_address",
  customer_addressController.createCustomer_address
);
...
router.get(
  "/Customer_address/:id",
  customer_addressController.getCustomer_addressById
);
...
router.put(
  "/customer_address/:id",
  customer_addressController.updateCustomer_address
);
...
router.delete(
  "/customer_address/:id",
  customer_addressController.deleteCustomer_address
);
